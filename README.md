...
2. Watch the URL bar—three rows of Braille brick glyphs (right edge), the ball, and the single-dot paddle on the left are drawn as glyphs in the path.
3. Use **↑/↓** or **W/S** to slide the paddle between the three braille rows. Press **R** to restart after a miss.
